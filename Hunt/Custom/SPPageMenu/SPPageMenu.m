...
- (void)initialize {
    ...
    functionButton.backgroundColor = [UIColor clearColor];
...
//    _shadowLine = shadowLine;
    ...
    gradientLayer.frame = functionButton.bounds;
    
//    CAGradientLayer *gradientLayer = [CAGradientLayer layer];
//    gradientLayer.colors = @[(__bridge id)[UIColor colorWithRed:11 green:11 blue:18 alpha:0].CGColor, (__bridge id)ColorFromHex(0x0b0b12).CGColor];
//    gradientLayer.locations = @[@0.8, @0.2];
//    gradientLayer.startPoint = CGPointMake(0, 0);
//    gradientLayer.endPoint = CGPointMake(1.0, 0);
//    gradientLayer.frame = functionButton.frame;
    [functionButton.layer insertSublayer:gradientLayer atIndex:0];
    gradientLayer.hidden = !_showFuntionButton;
    _shadowLine = gradientLayer;

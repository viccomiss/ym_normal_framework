...
//网格线颜色
#define GrateLineColor [UIColor colorWithRed:(235/255.0f) green:(235/255.0f) blue:(235/255.0f) alpha:1]
 ...
 */
#define TotalHeight (Portrait ? AdaptY(315) : (KSCREEN_WIDTH - MumTopMargin))

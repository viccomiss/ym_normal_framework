...
- (void)drawWithPositionArr:(NSArray *)positionArr
{
    ...
    self.lineWidth = 0.6;
    self.strokeColor = [UIColor colorWithRed:244/255.0 green:208/255.0 blue:82/255.0 alpha:0.5].CGColor;
    ...
    fillColorLayer.fillColor = [UIColor colorWithRed:244/255.0 green:208/255.0 blue:82/255.0 alpha:0.3].CGColor;
